...
export const REQUEST_SERVICE_NAME_DOC = '/microservice-readpaper-doc';
export const REQUEST_SERVICE_NAME_PAY = '/readpaper-pay';
export const REQUEST_SERVICE_NAME_AI_READING = '/microservice-ai-reading';
export const REQUEST_SERVICE_NAME_NOTE = '/microservice-note';
export const REQUEST_SERVICE_NAME_SUPERVISOR_REVIEW = '/microservice-supervisor-review';
